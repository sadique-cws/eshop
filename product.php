            ...
            <div class="container-fluid mt-5">
                <div class="row">
                   ...
                   ?>
                                <div class="col-lg-12">
                                    <div class="row">
                                        <div class="col-lg-4"> <img src="image/product/<?= $product['image'];?>" class="card-img-top" alt=""> </div>
                                        <div class="col-lg-8">
                                            <h5 class="h3 text-uppercase"><?= $product['title'];?></h5>
                                            <p class="h5"> <span class="text-success font-weight-bold">Rs. <?= $product['price'];?>/-</span> <span class="text-muted small"><del><?= $product['price'];?>/-</del></span> </p>
                                            <p class="small">Rs.
